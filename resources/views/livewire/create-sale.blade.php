<div>
    <form wire:submit="save" class="w-full">
        ...
        <div class="w-full md:w-1/5 px-3 mb-6 md:mb-0">
                <label class="block tracking-wide text-gray-700 text-s font-bold mb-2" for="product_id">Product</label>
                <select class="text-s w-full text-gray-700 border border-gray-200 rounded py-3 px-4 mb-2" id="product_id" wire:model.live="product_id">
